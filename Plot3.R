...
as.numeric(eletric.f$Sub_metering_1)
as.numeric(eletric.f$Sub_metering_2)
as.numeric(eletric.f$Sub_metering_3)
png(filename = "plot3.png", width = 480, height = 480, units = "px")
plot(eletric.f$Sub_metering_1 ~ eletric.f_p2, type = "l", ylab = "Energy sub metering")
plot(eletric.f$Sub_metering_2 ~ eletric.f_p2, type = "l", ylab = "Energy sub metering")
plot(eletric.f$Sub_metering_3 ~ eletric.f_p2, type = "l", ylab = "Energy sub metering")
dev.off()
